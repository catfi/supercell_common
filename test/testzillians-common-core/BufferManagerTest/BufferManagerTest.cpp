...
zillians::networking::RdmaDeviceResourceManager* g_RdmaDevMgr = NULL;

int main(int argc, char** argv)
{
	log4cxx::BasicConfigurator::configure();
	g_RdmaDevMgr = new zillians::networking::RdmaDeviceResourceManager();
...
int testRdmaBufMgr()
{
	g_BufferMgr = new zillians::networking::RdmaBufferManager(TEST_SIZE);
	if( g_BufferMgr == NULL )
	{
		return -1;
	}
