...
class GroupSessionEventDispatcher
{
public:
	virtual void registerListener(GroupSessionEventListener* listener) = 0;
	virtual void unregisterListener(GroupSessionEventListener* listener) = 0;
};

}

#endif /* GROUPSESSIONEVENTDISPATCHER_H_ */
