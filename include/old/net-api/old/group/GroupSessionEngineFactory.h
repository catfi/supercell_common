...
class GroupSessionEngineFactory
{
public:
	enum GroupSessionEngineBackend
	{
		BACKEND_SPREAD,
		BACKEND_QPID,
	};

	GroupSessionEngine* createInstance(GroupSessionEngineBackend backend);
};

}

#endif /* GROUPSESSIONENGINEFACTORY_H_ */
